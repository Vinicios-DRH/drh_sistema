...
from src.forms import (FichaAlunosForm, LtsAlunoForm, RecompensaAlunoForm,
                       RestricaoAlunoForm, SancaoAlunoForm, InativarAlunoForm)
from src.models import (LtsAlunos, RecompensaAluno, RestricaoAluno, SancaoAluno, FichaAlunos, AlunoInativo)
from src.querys import dados_para_mapa
