...
from src.forms import (FormViatura,
                       FormMotoristas, FormFiltroMotorista)
from src.models import (Militar, PostoGrad, Obm, MilitarObmFuncao,
                        Motoristas, Categoria, Viaturas, ViaturaMilitar)
